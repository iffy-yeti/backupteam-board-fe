// const younghwan = document.getElementById("table1")
...
// let tableresult = `<td>${id}</td>
// <td>${movie_title}</td>
// <td>${user_id}</td>
// <td>${hit_count}</td>
// <td>${created_at}</td>`
// younghwan.textContent += tableresult
//interHTML = HTML에 정보 넣거나 뺄 수 있는 함수 (younghwan), 띄어쓰기 무시
//textContent = 위랑 같은 기능, 차이는 있음, 있는 그대로 가져온당
